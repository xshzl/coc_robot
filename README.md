...
### 🎯 智能识别
- ✅ 基于 **YOLO v5/v8** 深度学习模型，精准识别游戏内建筑和资源
- ✅ **OCR 文字识别**，准确读取资源数值
- ✅ **模板匹配技术**，快速定位UI元素
...
### 新手入门
- [快速开始](#快速开始) - 5分钟上手指南
- [虚拟环境配置](#虚拟环境配置) - Python虚拟环境详细说明
- [配置说明](#配置说明) - 兵种、法术、参数设置

### 高级功能
- [📅 自动启动设置](docs/自动启动功能说明.md) - **推荐** - 在UI中设置每日自动启动
- [💻 命令行使用指南](docs/命令行使用指南.md) - 高级用户命令行启动方式

### 开发文档
- [🔧 任务开发指南](docs/每日任务开发文档.md) - 为开发者提供的API文档
...
- [任务开发指南](docs/每日任务开发文档.md) - 详细的API文档和开发规范

项目采用模块化设计，核心组件：
- `任务流程/` - 所有自动化任务的实现
- `模块/` - 图像识别、OCR、YOLO检测引擎
- `数据库/` - 配置和日志存储
- `界面/` - UI界面组件
