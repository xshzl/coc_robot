...
| 要自动升级的兵种或法术 | 选择 | 无 | 选择要在实验室研究升级的兵种或法术 |
| 研究升级检查间隔 | 数字 | `1` | 检查兵种/法术研究升级的时间间隔（小时） |
...
<details>
<summary><b>Q: 兵种/法术研究升级功能如何使用？</b></summary>

1. 在配置面板中选择 **"要自动升级的兵种或法术"**
2. 支持所有圣水兵种、黑油兵种、攻城器械和法术
3. 程序会自动检测：
   - 实验室是否空闲
   - 是否有正在进行的研究
   - 资源是否充足
   - 目标兵种/法术是否已解锁
4. 可设置 **"研究升级检查间隔"** 避免频繁检测（单位：小时，默认1小时）
5. 留空则不启用自动研究升级
</details>
