...
class 进攻任务(基础任务):
    ...
    def 执行(self, 上下文: 任务上下文) -> bool:
        ...
        可下乱生效类法术坐标=[(396,175),(454,204),(559,264),(306,231),(396,272),(464,324),(235,284),(351,353),(403,417)]

        # 遍历所有乱生效类法术，循环下完每个法术
        for 法术模板 in 乱生效类法术模板列表:
            法术失败次数 = 0
            首次检测 = True
            while True:
                # 从坐标列表中随机选择一个位置
                随机法术坐标 = random.choice(可下乱生效类法术坐标)
